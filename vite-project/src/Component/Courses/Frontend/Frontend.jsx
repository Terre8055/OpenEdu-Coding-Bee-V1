...
const Frontend = () => {
  ...
  const [currentType, setType] = useState("HTML CSS JS ");
  ...
  return (
    <div className="tutorial-container">
      <div className="tutorial-list">
        ...
        <ul>
          <li onClick={() => handleTypeChange("html tutorial by FreeCodeCamp")}>HTML</li>
          <li onClick={() => handleTypeChange("css tutorials")}>CSS</li>
          <li onClick={() => handleTypeChange("Full Javascript tutorials by FreeCodeCamp")}>JavaScript</li>
          <li onClick={() => handleTypeChange("reactjs tutorials and projects")}>ReactJS</li>
          <li onClick={() => handleTypeChange("TailwindCSS tutorials")}>TailwindCSS</li>
          <li onClick={() => handleTypeChange("NodeJS Full tutorials")}>Learn NodeJS</li>
          <li onClick={() => handleTypeChange("ExpressJS FreeCodeCamp")}>ExpressJS</li>
          <li onClick={() => handleTypeChange("MongoDB and Postgres full tutorials")}>DataBase Management</li>
        </ul>
        <div className="btn-sign"><button className="tut-btn" onClick={(e) => navigate('/')}>RETURN HOME</button></div>
      </div>
